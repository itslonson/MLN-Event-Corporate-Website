  ...
  <main>
    <section class="event">
      <div class="event-heading">
        <img src="~assets/images/events/icons/crown.svg" alt="MLN-event лого">
        <h1 class="h1-heading color-gray m0">VIP</h1>
      </div>
      ...
      <section class="event-images">
        <div class="image-row">
          <div class="image-column">
            <img
              id="myImg"
              src="https://firebasestorage.googleapis.com/v0/b/mln-event-2ce70.appspot.com/o/placeholders%2Fvip_1.png?alt=media&token=977fad48-7b20-4690-a068-e6862e8dc01d"
              alt="Вечеринка Диско"
            >
            <img
              id="myImg2"
              src="https://firebasestorage.googleapis.com/v0/b/mln-event-2ce70.appspot.com/o/placeholders%2Fvip_2.jpeg?alt=media&token=ea222491-ab71-43e2-8fb7-3622d21ff78b"
              alt="Литературный Вечер"
            >
          </div>
          <div class="image-column">
            <img
