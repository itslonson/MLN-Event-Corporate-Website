  ...
  <main>
    <section class="event">
      <div class="event-heading">
        <img src="~assets/images/events/icons/glasses.svg" alt="MLN-event лого">
        <h1 class="h1-heading color-gray m0">HR</h1>
      </div>
      ...
      <section class="event-images">
        <div class="image-row">
          <div class="image-column">
            <img
              id="myImg"
              src="https://firebasestorage.googleapis.com/v0/b/mln-event-2ce70.appspot.com/o/placeholders%2Fhr_1.jpg?alt=media&token=eee25c06-ccd9-430a-9385-149c97d7366b"
              alt="HR EVENT 2018"
            >
            <img
              id="myImg2"
              src="https://firebasestorage.googleapis.com/v0/b/mln-event-2ce70.appspot.com/o/placeholders%2Fhr_2.jpg?alt=media&token=30274aa4-0830-43a4-8024-60161d6046d7"
              alt="HR Пенная вечеринка"
            >
          </div>
          <div class="image-column">
            <img
