  ...
  <main>
    <section class="event">
      <div class="event-heading">
        <img src="~assets/images/events/icons/balloon.svg" alt="MLN-event лого">
        <h1 class="h1-heading color-gray m0">Детям</h1>
      </div>
      ...
      <div class="events-content">
        <div class="row">
          ...
          <div class="event-text">
            <h2 class="h2-heading color-gray">Детские праздники</h2>
            <p
      ...
      <section class="event-images">
        <div class="image-row">
          <div class="image-column">
            <img
              id="myImg"
              src="https://firebasestorage.googleapis.com/v0/b/mln-event-2ce70.appspot.com/o/placeholders%2Fkids_party1.jpg?alt=media&token=7e91da17-79b9-4739-9188-06da8ba442ac"
              alt="День ребенка"
            >
            <img
              id="myImg2"
              src="https://firebasestorage.googleapis.com/v0/b/mln-event-2ce70.appspot.com/o/placeholders%2Fkids_party2.jpg?alt=media&token=856fdff2-0d1a-4d58-aeb0-4f23a10aa569"
              alt="День Рождения"
            >
          </div>
          <div class="image-column">
